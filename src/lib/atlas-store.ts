...
export type WorkflowNodeConfigValue = string | number | boolean | ChoiceOption[];
export type WorkflowNodeConfig = Record<string, WorkflowNodeConfigValue>;
...
export type WorkflowRun = {
  ...
  duration_ms: number;
  triggered_by: string;
  node_states: Record<string, "queued" | "running" | "waiting" | "success" | "failed" | "skipped">;
  log: Array<{
    ts: string;
    node: string;
...
const initialWorkers: Worker[] = [
  ...
  {
    id: "wrk_03",
    name: "Coder · Company Mac",
    base_url: "http://100.64.1.12:4317",
    role: "coder",
    tags: ["company-a", "code"],
    status: "degraded",
    workspaces: ["thclaws", "atlas"],
    version: "1.3.9",
    last_seen: "2m ago",
  },
  {
    id: "wrk_04",
    name: "Reviewer · Edge",
    base_url: "http://100.64.1.14:4317",
    role: "reviewer",
    tags: ["review", "qa"],
    status: "offline",
    workspaces: [],
  ...
  {
    id: "wrk_05",
    name: "Research · GPU-01",
    base_url: "http://10.0.4.21:4317",
    role: "researcher",
    tags: ["gpu", "finance"],
    status: "online",
    workspaces: ["research", "finance"],
    version: "1.4.2",
    last_seen: "3s ago",
  },
];
...
const initialJobs: Job[] = [
  {
    id: "job_8829",
    prompt: "Summarize today's telecom incident logs...",
    worker: "Reporter · Local",
    workspace: "thclaws",
    state: "running",
    started_at: "14:22:01",
    duration_ms: 12400,
  ...
  {
    id: "job_8828",
    prompt: "Read the report as broadcast script.",
  ...
  {
    id: "job_8827",
    prompt: "Review PR #482 for regressions.",
    worker: "Coder · Company Mac",
    workspace: "atlas",
    state: "failed",
    started_at: "14:12:04",
    duration_ms: 4300,
  ...
  {
    id: "job_8826",
    prompt: "Extract entities from filing.",
    worker: "Research · GPU-01",
    workspace: "finance",
    state: "success",
    started_at: "14:04:22",
    duration_ms: 15600,
  ...
  nodes: [
    {
      ...
      x: 40,
      y: 200,
      config: { path: "/api/v1/ingest", auth: "hmac" },
    },
    {
      id: "n2",
      kind: "worker",
      ...
      config: {
        worker: "wrk_01",
        workspace: "thclaws",
        prompt: "Analyze incoming payload and extract priority signals.",
      },
    },
    {
      id: "n3",
    ...
    },
    {
      ...
      x: 820,
      y: 80,
      config: { worker: "wrk_02", workspace: "thclaws", prompt: "Compose broadcast script." },
    },
    {
      id: "n5",
      kind: "approval",
      ...
      x: 820,
      y: 320,
      config: { approvers: "ops-lead", timeout_s: "600" },
    },
  ...
  defaultWorkflow,
  {
    ...
    nodes: [
      { id: "n1", kind: "trigger", label: "Manual", x: 40, y: 160, config: {} },
      {
        ...
        x: 320,
        y: 160,
        config: { worker: "wrk_05", workspace: "research", prompt: "Gather sources." },
      },
      {
        id: "n3",
        kind: "worker",
        ...
        x: 620,
        y: 160,
        config: { worker: "wrk_01", workspace: "research", prompt: "Draft article from {result}." },
      },
    ],
    edges: [
      { id: "e1", source: "n1", target: "n2" },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        x: 320,
        y: 160,
        config: { worker: "wrk_03", workspace: "atlas" },
      },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        x: 320,
        y: 160,
        config: { worker: "wrk_01", workspace: "research" },
      },
    ],
...
const initialRuns: WorkflowRun[] = [
  {
    ...
    log: [
      { ts: "14:22:01.03", node: "SYSTEM", level: "info", text: "Workflow initialized." },
      {
        ...
        node: "WEBHOOK",
        level: "success",
        text: "Inbound request from 192.168.1.4 accepted.",
      },
      {
        ts: "14:22:02.12",
        node: "REPORTER",
        level: "info",
        text: "Executing Reporter Worker on chunk size 2048...",
      },
      {
        ts: "14:22:13.98",
        node: "REPORTER",
        level: "info",
        text: "Streaming: extracted 12 priority signals...",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    workflow_name: "Research → Writer Chain",
    state: "failed",
    started_at: "13:44:10",
    duration_ms: 6100,
    triggered_by: "manual",
    ...
    log: [
      {
        ...
        node: "RESEARCH",
        level: "error",
        text: "Worker returned 502 after retry #3.",
      },
    ],
  },
  {
    ...
    log: [
      { ts: "13:22:42", node: "APPROVAL", level: "warn", text: "Waiting for ops-lead approval..." },
    ],
  },
];
...
export const useAtlas = create<State>((set, get) => ({
  ...
  updateWorkflow: (id, patch) =>
    set((s) => ({
      workflows: s.workflows.map((w) =>
        w.id === id ? { ...w, ...patch, updated_at: "just now" } : w,
      ),
    })),
  updateRun: (id, patch) =>
    set((s) => ({ runs: s.runs.map((run) => (run.id === id ? { ...run, ...patch } : run)) })),
  ...
  addRun: (workflowId) => {
    ...
    const node_states = Object.fromEntries(
      wf.nodes.map((n, i) => [n.id, i === 0 ? "running" : "queued"]),
    ) as WorkflowRun["node_states"];
  ...
  addWorker: (w) =>
    set((s) => ({
      workers: [
        ...
        {
          ...w,
          id: `wrk_${String(s.workers.length + 1).padStart(2, "0")}`,
          status: "online",
          last_seen: now(),
        },
      ],
...
export const NODE_KINDS: { kind: NodeKind; label: string; hint: string }[] = [
  ...
  { kind: "decision", label: "Ask to choose", hint: "Let a person pick the next path" },
